...
function sky_css_alter(&$css) {
  ...
  // Override stylesheets provided by core.
  if ($css[drupal_get_path('module', 'user') . '/user.css']) {
    $css[drupal_get_path('module', 'user') . '/user.css']['data'] = drupal_get_path('theme', 'sky') . '/css/user.css';
  }
  if (isset($css['misc/ui/jquery.ui.theme.css'])) {
    $css['misc/ui/jquery.ui.theme.css']['data'] = drupal_get_path('theme', 'sky') . '/css/jquery.ui.theme.css';
  }
}
